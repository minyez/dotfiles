...
syn match aimsOutputOption	    "output\s\+\v<(basis|self_energy|gw_regular_kgrid|k_eigenvalue|matrices|grids|v_eff|v_hartree|band|dos|memory_tracking|batch_statistics)>"
