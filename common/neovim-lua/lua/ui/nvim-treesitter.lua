...
configs.setup {
  ...
  -- ensure_installed = { "cpp", "lua", "c", "python", "fortran", "org", "markdown", "javascript", "commonlisp", "xml" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
  ensure_installed = { "cpp", "lua", "c", "python", "fortran", "markdown", "javascript", "commonlisp", "xml" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
